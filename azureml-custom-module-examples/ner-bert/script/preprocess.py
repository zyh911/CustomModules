...
class NerProcessor:
    ...
    def get_examples(self, input_dataframe):
        """See base class."""
        return self._create_examples(
            self._read_dataframe(input_dataframe))
    ...
    @staticmethod
    def _read_dataframe(input_dataframe):
        return read_dataframe(input_dataframe)
...
class PreProcess:
    def __init__(self, meta: dict = {}):
        ...
        print("meta do lower case", meta['Do lower case'])
        self.do_lower_case = True if meta.get('Do lower case', 'False') == 'True' else False
        print("!!! do lower case", self.do_lower_case)
    ...
    def run(self, input_data_frame: pd.DataFrame, meta: dict = None):
        ...
        examples = processor.get_examples(input_data_frame)
        ...
        df_features = convert_examples_to_features_no_label(
            examples, self.max_seq_length, tokenizer) if no_label else convert_examples_to_features(
            examples, self.max_seq_length, tokenizer, label_list)
